      ...
      <main className="flex-1 py-12 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 md:px:6">
          <div className="prose max-w-4xl mx-auto">
            ...
            <h4>Contact List Data</h4>
            <p><strong>Examples of Personal Data We Collect:</strong></p>
            <ul>
              <li>Phone contact list (including contact names and phone numbers)</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data:</strong></p>
            <ul>
              <li>Service Providers</li>
            ...
            <p><strong>Examples of Personal Data We Collect:</strong></p>
            <ul>
                <li>Data about your usage of the Services, such as:</li>
                <li>Number of outgoing calls</li>
                <li>Number of missed calls</li>
                <li>Call minutes</li>
                <li>Number of sent messages</li>
                <li>Number of received messages</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data:</strong></p>
            <ul>
              <li>Service Providers</li>
            ...
            <ul>
              ...
              <li>Last 4 digits of the payment card</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data:</strong></p>
            <ul>
            ...
            <h4>Professional or Employment-Related Data</h4>
            <p><strong>Examples of Personal Data We Collect:</strong></p>
            <ul>
              <li>Job title</li>
              <li>Employer name</li>
              <li>Size of employer</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data:</strong></p>
            <ul>
              <li>Service Providers</li>
            ...
            <p><strong>Examples of Personal Data We Collect:</strong></p>
            <ul>
              <li>Recordings of phone calls</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data:</strong></p>
            <ul>
              <li>Service Providers</li>
            ...
            <h4>Other Identifying Information that You Voluntarily Choose to Provide</h4>
            <p><strong>Examples of Personal Data We Collect:</strong></p>
            <ul>
              <li>Identifying information in free form text provided on the Services or in emails or letters you send us</li>
            </ul>
            <p><strong>Categories of Third Parties With Whom We Share this Personal Data</strong></p>
            <ul>
                <li>Service Providers</li>
            ...
            <h2>3. Categories of Sources of Personal Data</h2>
            ...
            <h2>4. Our Commercial or Business Purposes for Collecting Personal Data</h2>
            ...
            <ul>
                <li>Responding to correspondence that we receive from you, contacting you when necessary or requested, and sending you information about Connectify or the Services.</li>
            ...
            <ul>
                ...
                <li>Protecting the rights, property, or safety of you, Connectify, or another party.</li>
            ...
            <p><strong>Service Providers.</strong> These parties help us provide the Services or perform business functions on our behalf. They include:</p>
            <ul>
                <li>Security and fraud prevention services</li>
                <li>Hosting, technology, and communication providers.</li>
                <li>Support and customer service vendors.</li>
                <li>Payment processors: Our payment processing partner Stripe, Inc. (“Stripe”) collects your voluntarily provided payment card information necessary to process your payment. Please see Stripe’s terms of service and privacy policy for information on its use and storage of your Personal Data.</li>
            </ul>
            <p><strong>Advertising Partners.</strong> These parties help us market our services and provide you with other offers that may be of interest to you. They include:</p>
            <ul>
                <li>Ad networks.</li>
                <li>Marketing providers.</li>
            </ul>
            <p><strong>Analytics Partners.</strong> These parties provide analytics on web traffic or usage of the Services. They include:</p>
            <ul>
            ...
            <p><strong>Business Partners.</strong> These parties partner with us in offering various services. They include:</p>
            <ul>
            ...
            <p><strong>Parties You Authorize, Access, or Authenticate</strong></p>
            <ul>
            ...
            <h2>8. Data that is Not Personal Data</h2>
            ...
            <h2>9. Tracking Tools, Advertising, and Opt-Out</h2>
            ...
            <h2>10. Information about Interest-Based Advertisements:</h2>
            ...
            <h2>11. Data Security and Retention</h2>
            ...
            <p>As noted in the Terms of Use, we do not knowingly collect or solicit Personal Data about children under 16 years of age; if you are a child under the age of 16, please do not attempt to register for or otherwise use the Services or send us any Personal Data. If we learn we have collected Personal Data from a child under 16 years of age, we will delete that information as quickly as possible. If you believe that a child under 16 years of age may have provided Personal Data to us, please contact us at hello@connectify.net.</p>

            <h2>13. State Law Privacy Rights</h2>
            <h3>California Resident Rights</h3>
            <p>Under California Civil Code Sections 1798.83-1798.84, California residents are entitled to contact us to prevent disclosure of Personal Data to third parties for such third parties’ direct marketing purposes; in order to submit such a request, please contact us at hello@connectify.net.</p>
            <h3>Nevada Resident Rights</h3>
            <p>If you are a resident of Nevada, you have the right to opt-out of the sale of certain Personal Data to third parties. You can exercise this right by contacting us at hello@connectify.net with the subject line “Nevada Do Not Sell Request” and providing us with your name and the email address associated with your account. Please note that we do not currently sell your Personal Data as sales are defined in Nevada Revised Statutes Chapter 603A.</p>
            ...
            <h2>16. Personal Data Use and Processing Grounds</h2>
            ...
            <ul>
              <li><strong>Contractual Necessity:</strong> We process the following categories of Personal Data as a matter of “contractual necessity”, meaning that we need to process the data to perform under our Terms of Use with you, which enables us to provide you with the Services. When we process data due to contractual necessity, failure to provide such Personal Data will result in your inability to use some or all portions of the Services that require such data.· Profile or Contact Data· Payment Data</li>
              <li><strong>Legitimate Interest:</strong> We process the following categories of Personal Data when we believe it furthers the legitimate interest of us or third parties:· Profile or Contact Data· Payment Data· Device/IP Data· Web Analytics· Social Network Data· Professional or Employment-Related Data· Geolocation Data· Other Identifying Information that You Voluntarily Choose to Provide· We may also de-identify or anonymize Personal Data to further our legitimate interests. Examples of these legitimate interests include (as described in more detail above):· Providing, customizing, and improving the Services.· Marketing the Services.· Corresponding with you· Meeting legal requirements and enforcing legal terms.· Completing corporate transactions.</li>
            ...
            <h2>17. Sharing Personal Data</h2>
            ...
            <p>You can request that we erase some or all of your Personal Data from our systems. To do so, please contact us at hello@connectify.net.</p>
            
            <h2>19. EU, UK, and Swiss Data Subject Rights</h2>
            <p>You have certain rights with respect to your Personal Data, including those set forth below. For more information about these rights, or to submit a request, please email us at hello@connectify.net. Please note that in some circumstances, we may not be able to fully comply with your request, such as if it is frivolous or extremely impractical, if it jeopardizes the rights of others, or if it is not required by law, but in those circumstances, we will still respond to notify you of such a decision. In some cases, we may also need you to provide us with additional information, which may include Personal Data, if necessary to verify your identity and the nature of your request.</p>
            <ul>
                ...
                <li><strong>Rectification:</strong> If you believe that any Personal Data we are holding about you is incorrect or incomplete, you can request that we correct or supplement such data. You can also correct some of this information directly by emailing hello@connectify.net.</li>
            ...
            <p>The Services are hosted and operated in the United States (“U.S.”) through Connectify and its service providers, and if you do not reside in the U.S., laws in the U.S. may differ from the laws where you reside. By using the Services, you acknowledge that any Personal Data about you, regardless of whether provided by you or obtained from a third party, is being provided to Connectify in the U.S. and will be hosted on U.S. servers, and you acknowledge that Connectify may transfer, store and process your information to and in the U.S., and possibly other countries.</p>

            <h2>21. Changes to this Privacy Policy</h2>
            <p>We’re constantly trying to improve our Services, so we may need to change this Privacy Policy from time to time, but we will alert you to any such changes by placing a notice on the Connectify website, by sending you an email and/or by some other means. Please note that if you’ve opted not to receive legal notice emails from us (or you haven’t provided us with your email address), those legal notices will still govern your use of the Services, and you are still responsible for reading and understanding them. If you use the Services after any changes to the Privacy Policy have been posted, that means you agree to all of the changes. Use of information we collect is subject to the Privacy Policy in effect at the time such information is collected.</p>
            ...
            <ul>
                <li>By email: hello@connectify.net</li>
            </ul>
          </div>
        </div>
      </main>
