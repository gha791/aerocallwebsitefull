...
const logos = [
  ...
  { name: 'Ramp', svg: <svg width="80" height="30" viewBox="0 0 80 30" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="0" y="20" fontFamily="Arial, sans-serif" fontSize="18" fontWeight="bold" fill="currentColor">Ramp</text></svg> },
  { name: 'Notion', svg: <svg width="90" height="30" viewBox="0 0 90 30" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="0" y="20" fontFamily="Arial, sans-serif" fontSize="18" fontWeight="bold" fill="currentColor">Notion</text></svg> },
  { name: 'Netflix', svg: <svg width="90" height="30" viewBox="0 0 90 30" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="0" y="20" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="currentColor">NETFLIX</text></svg> },
  { name: 'Plaid', svg: <svg width="80" height="30" viewBox="0 0 80 30" fill="none" xmlns="http://www.w3.org/2000/svg"><text x="0" y="20" fontFamily="Arial, sans-serif" fontSize="18" fontWeight="bold" fill="currentColor">Plaid</text></svg> },
